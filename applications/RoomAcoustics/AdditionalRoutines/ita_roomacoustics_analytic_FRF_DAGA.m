function varargout = ita_roomacoustics_analytic_FRF_DAGA(varargin)
...
% THIS GIVES THE SAME RESULT AS THE ORIGINAL VERSION!!! PDI
...
persistent delta %pdi/mgu DAGA mode - be careful!

%% Inits
sArgs.f_max     = sArgs.f_max;
% Q             = 1;
c               = double(sArgs.c);
% rho0          = double(sArgs.rho_0);
...
corr  = -(2 * pi * f_n) * 2 * 1i; %pdi:HUHU: not totally correct, should be j*omega by modal superposition
coeff = coeff ./ corr;
