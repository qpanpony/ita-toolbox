function varargout = ita_plot_quantile_freq_phase(varargin)
...
%% Initialization
sArgs = struct('pos1_data','itaSuper','nodb',true,'unwrap',true,'wrapTo360',false,'figure_handle',[],'axes_handle',[],'linfreq','off','linewidth',ita_preferences('linewidth'),...
...
[figHandle, axesHandles] = ita_plot_freq_phase(quantile_lines,'unwrapRefZeroFreq',100); % align phases based on 100 Hz, more robust than 0 Hz
