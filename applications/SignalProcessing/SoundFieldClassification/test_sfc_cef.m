...
%% Settings
settings = {'sfcmethod',6, 'sfdmode',2,'blocksize',2^10,'overlap',0.75,'sensorspacing',0.014,'direct_plot',false,'compensate',false,'fraction',3,'t_c',.5,'flimit',[50 22000],'psdbands',false,'calc_cef',true,'cef_blocksizes',4:1:20};
idx = 0;
bbfontscale = 1.15;
...
signal = ita_extract_dat(signal,19);
res(idx) = sfcfunc(signal,settings{:});
