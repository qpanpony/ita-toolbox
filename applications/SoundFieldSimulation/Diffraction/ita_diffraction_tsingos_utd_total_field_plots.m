...
att_sum.freqData = ita_diffraction_utd( w, src, rcv_positions, freq', c );
...
att_sum_approx.freqData = ita_diffraction_utd_approximated( w, src, rcv_positions, freq, c );
...
att_sum_diffr.freqData = ita_diffraction_utd( w, src, rcv_positions, freq, c );
...
subplot( 2, 2, 2 );
plot( rad2deg( alpha_d ), att_sum_approx.freqData_dB' )
...
subplot( 2, 2, 3 );
plot( rad2deg( alpha_d ), att_sum_error.freqData_dB' )
...
subplot( 2, 2, 4 );
plot( rad2deg( alpha_d ), att_sum_diffr.freqData_dB' )
