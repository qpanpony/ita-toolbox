...
\centering
	...
	\caption{Verlauf des Mittelwerts der frequenzabhängigen Absorption berechnet über \anzahlDerMessungen \ \samplesOderWiederholungen \ (durchgezogene Kurve) und Standardabweichung der Messergebnisse (gestrichelte Kurven). Kurven gleitend gemittelt: Glättungsparameter \smoothParameter \ Oktave, Gauß-Fenster}
