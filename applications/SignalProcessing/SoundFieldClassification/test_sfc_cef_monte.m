...
lT = [0.5 1 ];%1.5 2]; % Reverberation Times to be simulated
lDRR = [-20 0 20]; % DRRs to be simulated
lSNR = [inf]; % SNRs to be simulated
nReps = 20; % Number of repetitions of each setting;
signalFFTDegree = 21;
