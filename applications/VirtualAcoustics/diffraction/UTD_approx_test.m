...
% D1_1 = cot( (pi + (alpha_d - alpha_i)) ./ (2 * n) ) * F( k * L * a_plus(alpha_d - alpha_i, n) );
% D1_2 = n * exp( 1i * pi/4 ) * ... 
%          ( sqrt( 2 * pi .* k * L) * sgn( eps_plus(alpha_d - alpha_i, n) ) - ...
%          2 .* k * L * eps_plus(alpha_d - alpha_i, n) * exp( 1i * pi/4 ) );
