...
\begin{tabular}{|p{0.43\textwidth}p{0.51\textwidth}|}\hline
	...
	\underline{Beschreibung der Pr{\"u}feinrichtung:} \newline
	...
	\multicolumn{2}{|p{0.99\textwidth}|}{	\underline{Beschreibung des zu untersuchenden Materials und der Pr{\"u}fanordnung:}\newline
...
\centering
	...
	\caption{Verlauf des Mittelwerts der frequenzabh{\"a}ngigen Absorption berechnet {\"u}ber \anzahlDerMessungen \ \samplesOderWiederholungen \ (durchgezogene Kurve) und Standardabweichung der Messergebnisse (gestrichelte Kurven). Kurven gleitend gemittelt: Gl{\"a}ttungsparameter \smoothParameter \ Oktave, Gauﬂ-Fenster}
