function lspSignals = filterCTC_LS234(binauralInput, ctcFilter, crossoverFreq)
% filterCTC_LS234 - Filter binaural signal with CTC filter network
...
%  the loudspeaker count). This version supports two, three or four CTC
%  loudspeakers
...
switch ctcFilter.nChannels
    case 4 % two loudspeakers
    ...
    case 6 % three loudspeakers
        ...
        CTC_1R = ctcFilter.ch(3);
        CTC_2L = ctcFilter.ch(2);
        CTC_2R = ctcFilter.ch(5);
        CTC_3L = ctcFilter.ch(3);
        CTC_3R = ctcFilter.ch(6);
    ...
    otherwise
        ...
        error('The CTC filter must contain 4, 6 or 8 channels.')
end
