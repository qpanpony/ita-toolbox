...
%         'Style', 'text');
    ...
    uicontrol(...
        'Parent',h,...
        'FontSize',10,...
        'Position',[left_margin  7-(ch_idx)*(h_textbox+3) width_description  h_textbox-7],...
...
for idx = 1:floor(input.nSamples/segment_size)
    ...
    % x is important, used to wait for portaudio to finish.
    x = ita_portaudio(data, 'samplingRate',sampling_rate,'block',false,'reset',false,...
