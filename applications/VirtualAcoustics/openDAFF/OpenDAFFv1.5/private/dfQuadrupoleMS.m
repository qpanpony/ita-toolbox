function [ freqs, mags, metadata ] = dfDipoleMS( alpha, beta, basepath )
% Quadrupole magnitude spectrum weighted by frequency
...
% </ITA-Toolbox>
    ...
    for c=1:channels
        for f=1:length(freqs)
            mags(c,f) = abs(sin(alpha*pi/180))*abs(sin(beta*pi/90))/f;
        end
    end   
end
