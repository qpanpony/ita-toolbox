...
% ITAVA_NCTC_GUI Multichannel cross-talk cancellation GUI for VA
%       
...
function itaVA_NCTC_gui_OpeningFcn( hObject, ~, handles, varargin )
...
function varargout = itaVA_NCTC_gui_OutputFcn( ~, ~, handles) 
...
function connect_va_Callback( hObject, ~, handles )
