 ...
 * Correct taps must be used, and only two taps may be used here.
 *
 * This is a MEX-file for MATLAB.  
 * Bruno Masiero (bruno.masiero@poli.usp.br), Feb 2004
 *=================================================================*/
#include <math.h>
#include "mex.h"
#include "matrix.h"
...
void mls(unsigned long int n, unsigned long int tap1, unsigned long int tap2,
                         double *y, double *row, double *col)
{
	...
	for (i=0;i<L-n;i++) *(temp+i+n) = *(temp+n+i-tap1) ^ *(temp+n+i-tap2);   /*comprimento de ordem n.*/
...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    unsigned long int n, tap1, tap2, L;
    double *y, *row, *col;
