...
params.stages.errors.normalize = 1;             % Normalized the error for each assumed position.
...
params.errors.display_z = -0.4:0.2:0.2; % Error displayed on x-y plane for these z values.
