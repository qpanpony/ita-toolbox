...
sine2.channelNames{1} = 'the copy of the first sine';

% Put them together in one object
sine_comp = merge(sine, sine2);

% Convert to time domain with .' (ifft) - this is done internally every 
% time you plot if the data is in the wrong domain.
sine = sine.';
